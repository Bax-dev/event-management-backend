const { CreateBookingRequestModel } = require('../../../src/model/request/booking/create-booking.request');

describe('CreateBookingRequestModel', () => {
  describe('validate', () => {
    it('should return valid for correct data', () => {
      ...
      const model = new CreateBookingRequestModel(data);
    ...
    it('should return invalid when numberOfTickets exceeds 100', () => {
      ...
      expect(result.isValid).toBe(false);
      expect(result.errors).toContain('Cannot book more than 100 tickets at once');
    });
